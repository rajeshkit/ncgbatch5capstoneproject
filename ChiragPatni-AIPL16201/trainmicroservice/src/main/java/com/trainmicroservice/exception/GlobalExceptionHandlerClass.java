...
public class GlobalExceptionHandlerClass {
    @ExceptionHandler(TrainNumberDoesNotExistException.class)
    public ResponseEntity<?> handlerTrainNumberNotExists(TrainNumberDoesNotExistException ex, HttpServletRequest request) {
