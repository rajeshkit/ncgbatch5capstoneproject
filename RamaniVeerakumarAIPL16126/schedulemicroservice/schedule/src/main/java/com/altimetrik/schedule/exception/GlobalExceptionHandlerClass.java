...
public class GlobalExceptionHandlerClass {
    @ExceptionHandler(ScheduleIdNotExitsException.class)
    public ResponseEntity<?> handlerProductIdNotExists(ScheduleIdNotExitsException ex, HttpServletRequest request) {
