...
public class GlobalExceptionHandlerClass {
    ...
    public ResponseEntity<ApiError> handleTrainNumberNotExistsException(RouteIdNotExistsException ex, HttpServletRequest request) {
    ...
    @ExceptionHandler(RouteIdAlreadyExistsException.class)
    @ResponseStatus(HttpStatus.CONFLICT)
    public ResponseEntity<ApiError> handleRouteIdAlreadyExistsException(RouteIdAlreadyExistsException ex, HttpServletRequest request) {
