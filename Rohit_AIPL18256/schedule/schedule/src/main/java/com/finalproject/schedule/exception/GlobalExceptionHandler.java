...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(TrainIsNotExistException.class)
    public ResponseEntity<?> handlerTrainIsNotExistException(TrainIsNotExistException rnx, HttpServletRequest hsrt) {
