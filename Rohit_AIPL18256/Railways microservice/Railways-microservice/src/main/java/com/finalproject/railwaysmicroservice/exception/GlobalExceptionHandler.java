...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(TrainIsNotExistHereException.class)
    public ResponseEntity<?> handlerTrainIsNotExistException(TrainIsNotExistHereException tx , HttpServletRequest hst ){
