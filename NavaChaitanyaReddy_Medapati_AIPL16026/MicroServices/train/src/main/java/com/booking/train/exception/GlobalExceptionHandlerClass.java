...
public class GlobalExceptionHandlerClass {
    ...
    public ResponseEntity<ApiError> handlerProductIdNotExists(TrainNumberNotExistsException ex, HttpServletRequest request)
    {
        ApiError apiError= ApiError.builder().apiErrorDate(new Date())
