...
public class GlobalExceptionHandlerClass {
    ...
    public ResponseEntity<?> handlerRouteNotFound(RouteNotFoundException ex, HttpServletRequest request) {
    ...
    @ExceptionHandler(RouteIdAlreadyExists.class)
    public ResponseEntity<?> handlerRouteIdAlreadyExists(RouteIdAlreadyExists ex, HttpServletRequest request) {
        ApiError apiError=ApiError.builder()
                .path(request.getRequestURI())
                .message(Arrays.asList(ex.getLocalizedMessage()))
                .status(HttpStatus.NOT_FOUND.toString()).build();
