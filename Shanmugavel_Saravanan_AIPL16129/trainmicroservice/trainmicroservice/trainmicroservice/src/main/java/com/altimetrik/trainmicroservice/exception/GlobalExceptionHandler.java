...
public class GlobalExceptionHandler{
    ...
    public ResponseEntity<?> handlerTrainNumberNotFound(TrainNumberNotFoundException ex, HttpServletRequest request) {
    ...
    @ExceptionHandler(TrainNumberAlreadyExists.class)
    public ResponseEntity<?> handlerTrainNumberAlreadyExists(TrainNumberAlreadyExists ex, HttpServletRequest request) {
        ApiError apiError=ApiError.builder()
                .path(request.getRequestURI())
                .message(Arrays.asList(ex.getLocalizedMessage()))
                .status(HttpStatus.NOT_FOUND.toString()).build();
