...
public class GlobalExceptionHandlerClass{
    ...
    public ResponseEntity<?> handlerScheduleNotFound(ScheduleNotFoundException ex, HttpServletRequest request) {
        com.altimetrik.schedulemicroservice.exception.ApiError apiError= com.altimetrik.schedulemicroservice.exception.ApiError.builder()
