...
public class GlobalExceptionHandlerClass
{
    ...
    // Route ID Does not Exist Error Exception Handling
    @ExceptionHandler(RouteIdNotExistException.class)
    public ResponseEntity<?> handlerTrainNumberNotExists(RouteIdNotExistException ex, HttpServletRequest request) {
