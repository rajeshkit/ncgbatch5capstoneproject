...
public class RouteController {
    ...
    public Route getRouteById(@PathVariable("id") String routeId) throws RouteIdNotExistsException {
    ...
    public String deleteRouteById(@PathVariable("id") String routeId) throws RouteIdNotExistsException {
