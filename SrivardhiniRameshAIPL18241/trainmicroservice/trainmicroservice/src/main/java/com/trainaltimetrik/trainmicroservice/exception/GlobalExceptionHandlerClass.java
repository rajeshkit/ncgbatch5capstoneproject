...
public class GlobalExceptionHandlerClass {
    ...
    public ResponseEntity<?> handlerTrainNumberDoesNotExist(TrainNumberNotExistException ex, HttpServletRequest request) {
    ...
    @ExceptionHandler(TrainNumberAlreadyExistException.class)
    public ResponseEntity<?> handlerTrainNumberAlreadyExist(TrainNumberAlreadyExistException ex, HttpServletRequest request) {
        ApiError apiError=ApiError.builder()
                .path(request.getRequestURI())
                .message(Arrays.asList(ex.getLocalizedMessage()))
                .status(HttpStatus.NOT_FOUND.toString()).build();
