...
import com.train.trainmicroservice.exception.APIError;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<APIError> handlerScheduleIdNotExistsException(ScheduleIdNotExistsException e, HttpServletRequest request){
    ...
    public ResponseEntity<APIError> handlerMethodArgumentNotValidException(MethodArgumentNotValidException m, HttpServletRequest request){
        ...
        com.train.trainmicroservice.exception.APIError apiError=new APIError(new Date(),request.getRequestURI(),listOfError, HttpStatus.BAD_REQUEST.toString());
