package com.booking_details.route.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handlerRouteIdNotExistsException(RouteIdNotFoundException e,HttpServletRequest request){
